...
【输出结构】
按下面的板块组织(没有内容的板块直接整段省略,不要写"暂无内容"):
...
【格式要求】
1. 全部中文,英文专有名词原样保留
2. 每条 1-2 行,要点先行,产品名/公司名/模型名加粗 <b>...</b>
3. 每条结尾附 <a href="原文URL">原文</a>(必须是有效非空的 https 链接,从给的"链接:"字段取)
4. 同一话题多人转发只保留一条最权威的
5. 仅用 Telegram HTML 三种标签: <b> <i> <a href="...">,不要 markdown,不要 ```
6. 开头第一行: <b>📰 AI 应用速报 · {date}</b>
7. 结尾另起一段: <i>今日关键词:xxx / xxx / xxx</i>(3-5 个)
8. 总长度 ≤ 3500 字
